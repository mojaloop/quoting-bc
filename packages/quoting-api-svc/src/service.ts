...
import {MongoBulkQuotesRepo, MongoQuotesRepo} from "@mojaloop/quoting-bc-implementations-lib";
...
const APP_NAME = "quoting-api-svc";
...
export class Service {
    ...
    static setupExpress(): Promise<void> {
        return new Promise<void>(resolve => {
            ...
            const quoteAdminRoutes = new QuotingAdminExpressRoutes(this.quotesRepo, this.bulkQuotesRepo, this.logger, this.tokenHelper, this.authorizationClient);

            this.app.use("/", quoteAdminRoutes.mainRouter);
            ...
            this.expressServer = this.app.listen(portNum, () => {
                ...
                globalLogger.info(`Quoting Admin server v: ${APP_VERSION} started`);
                resolve();
            });
        });
    }
