# Quoting Bounded Context - Quoting Service
...
```bash
docker build -f packages/quoting-api-svc/Dockerfile -t mojaloop/quoting-bc-quoting-api-svc:0.1.0 .
```
...
| SVC_CLIENT_ID        | Service client ID                 | quoting-bc-api-svc                 |
