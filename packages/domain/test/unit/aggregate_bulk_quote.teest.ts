...
import { mockedBulkQuote1, mockedQuote2 } from "@mojaloop/quoting-shared-mocks";
...
describe("Domain - Unit Tests for Bulk Quote Events", () => {
    ...
    test("handleBulkQuoteRequestedEvt - should publish QuoteRequestAcceptedEvt if event runs successfully", async () => {
        ...
        jest.spyOn(participantService, "getParticipantInfo")
            ...
            .mockResolvedValue({ id: destinationFspId, type: "DFSP", isActive: true} as Participant as any);
